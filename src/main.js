...
class Game extends eskv.App {
    ...
    syncUiWithGameState() {
        ...
        objectiveLabel.text = `${view.objectiveTitle} [${view.objectiveStatus}]`;
        seedLabel.text = `Run: ${view.runSeed} | Mission: ${view.missionSeed} (#${view.missionIndex})`;
